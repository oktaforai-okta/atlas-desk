...
working tenant (example.oktapreview.com, ProGearSales -> ProGearInventory).
...
SVC = ENV["INTAKE_SERVICE_CLIENT_ID"]        # 0oaEXAMPLEIntakeSvc1
SEC = ENV["INTAKE_SERVICE_SECRET"]
TRI = ENV["INTAKE_AGENT_ID"]                 # wlpEXAMPLEAgentOne01  (Atlas Triage, caller)
RES_CAS = "ausEXAMPLEDelegate01"             # Atlas Resolution CAS (target)
RES_URL = "https://atlas.acme.example/resolution"

# Caller-side CAS created via API 2026-06-30 (aud = triage-resource).
TRIAGE_CAS = "ausEXAMPLEReadLane01"          # "Atlas Triage A2A"
