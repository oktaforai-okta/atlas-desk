...
class EventStream:
    ...
    Deliberately does not retain credentials past the stream. Tokens belong to the
    run that produced them and to the browser watching it; the server keeping a
    copy so other visitors can see them was a wrong turn, since a viewer who did
    not run anything has no business being shown a credential.
    """
