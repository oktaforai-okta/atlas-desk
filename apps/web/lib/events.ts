...
function mockSequence(t: Ticket): ChainEvent[] {
  ...
  const triage = "Atlas Triage Agent · wlpEXAMPLEAgentOne01";
  const resolution = "Atlas Resolution Agent · wlpEXAMPLEAgentTwo01";
  ...
  return [
    ...
    { step: "a2a_exchange", label: "A2A token exchange", status: "ok",
      ...
      token_claims: {
        sub: "wlpEXAMPLEAgentOne01",
        act: { sub: "wlpEXAMPLEAgentOne01", purpose: "agent.invoke" },
