    ...
    <div className="mx-auto max-w-[1600px] px-8 py-8">
      <div className="max-w-3xl">
        ...
        <p className="mt-2 text-[16px] leading-relaxed text-body">
          ...
          which bootstraps a chain of three governed AI agents (Triage, Resolution, Fulfillment) each a
          first-class <span className="text-ink">workload principal</span> that Okta brokers, owns, and can
          revoke. Explore it: scroll to zoom, drag a node, hover to trace its connections, or replay the
      ...
      <div className="mt-3 grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-4">
        {[
          ...
          { icon: KeyRound, layer: "Runtime", v: "Only Fulfillment can touch prod, and its Jira credential is vaulted in OPA and brokered just-in-time, nothing static lives in agent code." },
