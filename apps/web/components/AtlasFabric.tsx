...
const RAW_NODES: Omit<FNode, "x" | "y">[] = [
  ...
  { id: "triage", label: "Triage", role: "AI Agent", idKind: "WLP ID", idVal: "wlpEXAMPLEAgentOne01", icon: "bot", type: "agent", color: C.triage, tx: 670, ty: 180 },
  { id: "resolve", label: "Resolution", role: "AI Agent", idKind: "WLP ID", idVal: "wlpEXAMPLEAgentTwo01", icon: "bot", type: "agent", color: C.resolve, tx: 930, ty: 180 },
  { id: "fulfill", label: "Fulfillment", role: "AI Agent", idKind: "WLP ID", idVal: "wlpEXAMPLEAgentThr01", icon: "bot", type: "agent", color: C.fulfill, tx: 1190, ty: 180 },
