...
1. In the shared Render project **prj-EXAMPLEPROJECT** → **New → Blueprint** (or Web Service), connect `astro7982/jc-devops-desk`, pick this deploy branch. Render reads `render.yaml` and proposes **atlas-orchestrator** (Starter, rootDir `apps/orchestrator`).
